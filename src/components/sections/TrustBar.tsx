...
export function TrustBar() {
  return (
    <section className="section-dark py-16 md:py-20 border-b border-brushed-steel/30">
      <div className="max-w-[1860px] mx-auto px-6 md:px-12 lg:px-[30px]">
        ...
        >
          {/* Label */}
          <p className="text-xs uppercase tracking-[0.2em] text-machine-gray mb-10 font-medium">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-10 w-full max-w-3xl">
            {badges.map((badge, i) => (
              ...
              >
                <div className="inline-flex items-center justify-center w-12 h-12 mb-3 border border-brushed-steel/30 bg-forged-slate/50">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="text-molten-copper">
                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
                <p className="text-sm font-display font-semibold text-titanium-white">{badge.label}</p>
