      ...
      >
        <div>
          ...
          <p className="text-sm text-gray-400 mt-0.5">
            Plantillas de propuestas, contratos y referencias internas
          </p>
        </div>
      </motion.div>
              ...
              <div className="flex items-center justify-between pt-3 border-t border-brushed-steel/10">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-medium text-gray-300 bg-brushed-steel/10 hover:bg-brushed-steel/20 rounded transition-colors"
                  >
                    <svg
                      width="12"
                      height="12"
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-medium text-white bg-molten-copper/80 hover:bg-molten-copper rounded transition-colors"
                  >
                    <svg
                      width="12"
                      height="12"
